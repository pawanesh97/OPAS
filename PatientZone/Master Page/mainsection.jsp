            ...
            <div class="row" style="min-height: 1050px;">
             <div class="col-sm-12" style="min-height: 350px; background-color: whitesmoke;">
                ...
                <div class="col-sm-4" style="min-height: 200px; background-color: skyblue">
                    ...
                    <a href="bookappointment.jsp" target="_blank"><h3 style="min-height: 100px; width:400px; background-color: orange; color:black;padding:50px; border-radius:10px; text-decoration: none;">Online Appointment ON-BOARDING MANNUAL</h3></a>
                    
                </div>
                <div class="col-sm-4" style="min-height: 200px; background-color: skyblue">
                    <a href="registration.jsp" target="_blank"><h3 style="min-height: 100px; width:400px; background-color: orange; color:black;padding:50px; border-radius:10px; text-decoration: none;">HOSPITALS JOIN HERE</h3></a>
                </div>
                <div class="col-sm-4" style="min-height: 200px; background-color: skyblue">
                    <a href="hlogin.jsp" target="_blank"><h3 style="min-height: 100px; width:400px; background-color: orange; color:black;padding:50px; border-radius:10px; text-decoration: none;"><center>HOSPITAL LOGIN</center></h3></a>
                </div>
                <div class="col-sm-12" style="min-height: 50px; background-color: #0f0f0f;"></div>
                    ...
                    <div class="col-sm-3" style="background-color:red; min-height: 150px; border-radius: 30px; margin-left: 40px;">
                        ...
                        <h5 class="h3" style="color:white; text-align: center;text-shadow: 2px 2px 5px black;">Number of Hospital</h5>
                    </div>
                    <div class="col-sm-1"></div>
                    <div class="col-sm-3" style="background-color: yellow; min-height: 150px;border-radius:30px;">
                        <h4 class="h3" style="color:white; text-align: center;text-shadow: 2px 2px 5px black;">Appointment Taken Today</h4>
                    </div>
                    <div class="col-sm-1"></div>
                    <div class="col-sm-3" style="background-color: skyblue; min-height: 150px; border-radius:30px;">
                        <h4 class="h3" style="color:white; text-align: center;text-shadow: 2px 2px 5px black;">Total Appointments</h4>
                    </div>
