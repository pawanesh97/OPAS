<html>
    <head>
        ...
        <title>Search Doctor | Online Patient Appointment System</title>
    ...
    <body>
        ...
        <div class="container-fluid">
         ...
         <div class="row main">
             <center> 
             <div class="container" style="margin:0px auto; min-height: 500px;border:1px solid; box-shadow: 2px 2px 15px green; border-radius:20px;">
...
<option>Union territories</option>
                     ...
                     <br>
                     <input type="text" placeholder="Enter Doctor Name" name="password" class="form-control a1"/><br/><br/>
                     
                     <input type="submit" value="Search" class="btn btn-success a2" style="width:60%;"/><br/>
